...
export default function SafeContractor({ t }: { t: TFunction }) {
  const safeContractorProductProps = {
    productName: 'SafeContractor',
      ...
      items: [
        {
          ...
          imageUrl: `${IMAGE_BASE_URL}/logos/SafeContractor/capabilities/Dashboard - All.png`,
          capabilityDetails: <div>{t('navListItemContent_01')}</div>,
        },
        {
          listItem: t('navListItemTitle_02'),
          imageUrl: `${IMAGE_BASE_URL}/logos/SafeContractor/capabilities/reduce time to onboard.png`,
          capabilityDetails: <div>{t('navListItemContent_02')}</div>,
        },
        {
          listItem: t('navListItemTitle_03'),
          imageUrl: `${IMAGE_BASE_URL}/logos/SafeContractor/capabilities/instant view of compliance.png`,
          capabilityDetails: <div>{t('navListItemContent_03')}</div>,
        },
        {
          listItem: t('navListItemTitle_04'),
          imageUrl: `${IMAGE_BASE_URL}/logos/SafeContractor/capabilities/spot trends.png`,
          capabilityDetails: <div>{t('navListItemContent_04')}</div>,
        },
        {
          listItem: t('navListItemTitle_05'),
          imageUrl: `${IMAGE_BASE_URL}/logos/SafeContractor/capabilities/ensure contractor safety.png`,
  ...
  useTrackPageDuration('SafeContractor Product Page Visited');
  return (
    <UserPage showLeftNav={false}>
      <ProductPage {...safeContractorProductProps} />
    </UserPage>
  );
}
